...
const PILLARS: Pillar[] = [
  {
    ...
    footnote: 'ESA-certified · 100% first-visit pass rate',
    iconPath:
      'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
  },
  {
    title: '2-year labour warranty on every job.',
    body: 'My workmanship is covered for two full years from the day the inspection passes. Manufacturer warranties on parts (Eaton, Square D, Leviton) are on top of that.',
