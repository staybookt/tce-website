          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-white/80 text-xs font-bold uppercase tracking-wider mb-0.5">Call</p>
                <p className="text-white font-display font-bold text-base md:text-lg leading-tight truncate">{client.phone}</p>
                <p className="text-white/80 text-xs mt-0.5">Tim picks up · same day</p>
              </div>
            </a>
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-amber-400 text-xs font-bold uppercase tracking-wider mb-0.5">Text</p>
                <p className="text-white font-display font-bold text-base md:text-lg leading-tight truncate">{client.phone}</p>
                <p className="text-white/60 text-xs mt-0.5">Send a photo of the issue</p>
              </div>
            </a>
          ...
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-16">
            ...
            <div className="space-y-10">
              <div>
                ...
                <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-5 tracking-tight leading-[1.05]">
                  Tim responds{' '}
                  <span className="gradient-text">within 2 hours.</span>
                </h2>
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                  During business hours we typically text back within 30 minutes. After-hours and weekends, expect a same-day or next-morning reply unless it&apos;s an emergency &mdash; then call.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-amber-50/40 to-white border border-amber-100 rounded-2xl p-5 md:p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-amber-700 font-bold text-xs uppercase tracking-[0.2em]">Hours</p>
                  </div>
                ...
                <div className="bg-gradient-to-br from-amber-50/40 to-white border border-amber-100 rounded-2xl p-5 md:p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-amber-700 font-bold text-xs uppercase tracking-[0.2em]">Service area</p>
                  </div>
                  ...
                  <div className="grid grid-cols-[1fr_auto] gap-4 items-center">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        12 cities across York Region, Simcoe County, and Durham Region.
                      </p>
                      <Link href="/areas" className="inline-flex items-center gap-1.5 mt-3 text-amber-600 hover:text-amber-700 font-bold text-xs">
                        See all areas
                    ...
                    <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-xl bg-white border border-amber-100 shadow-sm overflow-hidden shrink-0">
                      <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" aria-hidden="true">
                        <defs>
                          <radialGradient id="cz" cx="0.5" cy="0.5" r="0.5">
                            <stop offset="0%" stopColor="#fcd34d" stopOpacity="0.5" />
                            <stop offset="100%" stopColor="#fcd34d" stopOpacity="0" />
                          </radialGradient>
                        </defs>
                        <circle cx="50" cy="50" r="42" fill="url(#cz)" />
                        ...
                        {[[50,32],[47,21],[34,22],[26,32],[26,46],[33,58],[50,58],[44,62],[60,66],[68,58],[72,44]].map(([x,y],i) => (
                          <g key={i}>
                            <circle cx={x} cy={y} r={1.8} fill="#f59e0b" opacity="0.2" />
                            <circle cx={x} cy={y} r={1.2} fill="#f59e0b" />
                          </g>
                        ))}
                        ...
                        <circle cx="50" cy="50" r="2.8" fill="#f59e0b" />
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5 md:p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {client.paymentMethods.map((method) => (
                      <span key={method} className="bg-white border border-gray-200 px-3 py-1.5 rounded-lg text-sm text-gray-700 font-semibold">
                        {method}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mb-10">
            <p className="text-amber-600 font-semibold text-sm uppercase tracking-[0.2em] mb-3">What happens next</p>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 tracking-tight leading-[1.05]">
              From form to finished job.
            </h2>
            <p className="text-gray-600 text-base md:text-lg mt-4 leading-relaxed">
              No mystery. Here&apos;s exactly what happens after you call or send the form.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              <div key={step.num} className="bg-white border border-gray-200 rounded-2xl p-6 md:p-7 hover:border-amber-300 hover:shadow-md transition-all">
                ...
                <h3 className="font-display font-bold text-gray-900 text-base mb-2 tracking-tight">{step.title}</h3>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="relative inline-flex w-3 h-3">
                  ...
                  <span className="relative rounded-full w-3 h-3 bg-red-500" />
                </span>
                <p className="text-red-700 font-bold text-xs uppercase tracking-[0.25em]">Electrical Emergency · 24/7</p>
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight leading-[1.05]">
                Sparks, smoke, or burning smell?{' '}
                <span className="text-red-600">Don&apos;t wait.</span>
              </h2>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-xl">
                Sparking outlets, burning smells, power outages, tripped breakers that won&apos;t reset. Tim picks up day or night. If there&apos;s active fire or someone&apos;s been shocked &mdash; call 911 first.
              </p>
            </div>
            <div className="flex flex-col gap-3 md:items-end">
              <a
                href={`tel:${client.phone}`}
                className="inline-flex items-center justify-center bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-4 rounded-xl text-base md:text-lg transition-all shadow-lg shadow-red-200 hover:scale-[1.02] whitespace-nowrap"
              >
                Call now &mdash; {client.phone}
              </a>
              <Link
                href="/emergency-electrician"
                className="text-red-600 hover:text-red-700 font-bold text-sm transition-colors inline-flex items-center gap-1.5"
              >
