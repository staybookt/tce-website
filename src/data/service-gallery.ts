...
export const serviceGallery: Record<string, { src: string; alt: string }[]> = {
  ...
  'landscape-lighting': [
    ...
    { src: '/images/work/IMG_6204.webp', alt: 'Top Choice Electrical landscape lighting in York Region' },
    { src: '/images/work/IMG_5375.webp', alt: 'Top Choice Electrical landscape lighting in York Region' },
  ],
  ...
  'knob-and-tube-removal': [
    ...
    { src: '/images/work/IMG_6785.webp', alt: 'Top Choice Electrical knob and tube removal in York Region' },
  ],
  'residential-wiring': [
  ...
  'commercial-electrical': [
    ...
    { src: '/images/work/IMG_5017.webp', alt: 'Top Choice Electrical commercial electrical in York Region' },
    { src: '/images/work/IMG_5695.webp', alt: 'Top Choice Electrical commercial electrical in York Region' },
  ],
  'generator-installation': [
    ...
    { src: '/images/work/IMG_5375.webp', alt: 'Top Choice Electrical generator installation in York Region' },
    { src: '/images/work/IMG_5017.webp', alt: 'Top Choice Electrical generator installation in York Region' },
  ],
  'smoke-co-detectors': [
  ...
  'aluminum-wiring': [
    ...
    { src: '/images/work/IMG_6785.webp', alt: 'Top Choice Electrical aluminum wiring in York Region' },
  ],
  ...
  'surge-protection': [
    ...
    { src: '/images/work/IMG_1140.webp', alt: 'Top Choice Electrical surge protection in York Region' },
  ],
  'ceiling-fan-installation': [
    ...
    { src: '/images/work/IMG_1140.webp', alt: 'Top Choice Electrical ceiling fan installation in York Region' },
    { src: '/images/work/IMG_5017.webp', alt: 'Top Choice Electrical ceiling fan installation in York Region' },
  ],
};
